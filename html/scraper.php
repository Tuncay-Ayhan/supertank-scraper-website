<?php
echo "<img src='https://www.supertank.nl/media/blifg200/logo_supertank_lang.svg' alt='Supertank'>";
// Open the CSV file for reading
$file = fopen("gas_prices.csv", "r");

echo "<table style='font-family: \"Helvetica\", sans-serif; font-size: 14px; border: 1px solid black'>";
